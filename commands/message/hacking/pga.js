module.exports = {
    ...
    async execute(client, message, args, Discord){
        ...
        if (args[1] === "attacks") {
            message.reply("Attacks include High Commission India Website Breaches, Operation Closed Media, Prime Minister of Greece Attacks, School Network of Greece Attacks, Odysseas Konstantinopoulos Attacks, Institute of Sociological and Political Legal Research of North Macedonia Attacks, Turkey Bank Attacks and Parimal Kopardekar Attacks.");
        }
    }
};